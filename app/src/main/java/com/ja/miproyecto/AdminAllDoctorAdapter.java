...
public class AdminAllDoctorAdapter extends RecyclerView.Adapter<AdminAllDoctorAdapter.ViewHolder> {
    ...
    public AdminAllDoctorAdapter(List<DoctorsProfile> listData, List<String> emaildata, Context mContext) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(view.getContext(), AdminDoctorDetails.class);
