...
public class DoctorMessageAdapter extends RecyclerView.Adapter<DoctorMessageAdapter.ViewHolder> {
    ...
    public DoctorMessageAdapter(Context mContext, List<Chat> mChat, String imageurl, String emailID) {
