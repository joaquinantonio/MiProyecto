...
public class PatientPrescription extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PatientSessionManagement session = new PatientSessionManagement(PatientPrescription.this);
    ...
    private void send_prescription_over_mail() {
        ...
        View view = LayoutInflater.from(PatientPrescription.this).inflate(R.layout.prescription_over_mail, null);
        final EditText emailText = view.findViewById(R.id.emailEt);
        Button get = view.findViewById(R.id.send_email);
        final AlertDialog.Builder builder = new AlertDialog.Builder(PatientPrescription.this);
        ...
        get.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(emailid)){
                    Toast.makeText(PatientPrescription.this, "Enter Your email id...", Toast.LENGTH_SHORT).show();
                    return;
                }
                message="";
                ...
                try {
                    ...
                    Toast.makeText(PatientPrescription.this, "Request failed try again: "+ t.toString(), Toast.LENGTH_LONG).show();
                }
