...
public class ViewAllSpeciality extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_all_speciality);
        ...
        view_all_adapter =new ViewAllAdapter(main_specialisations, ViewAllSpeciality.this);
    ...
    private void filter(String text) {
        ...
        ArrayList<MainSpecialisation> filterdNames = new ArrayList<>();
        for (MainSpecialisation doc_data: main_specialisations) {
