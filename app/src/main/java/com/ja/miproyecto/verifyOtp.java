...
public class verifyOtp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String new_mobile = "+60" + getIntent().getStringExtra("mobile");
...
//
                                            ...
                                            PatientPhoneNumber patientPhoneNo = new PatientPhoneNumber(new_mobile);
                                            PatientSessionManagement session_management = new PatientSessionManagement(verifyOtp.this);
                                            session_management.saveSession(patientPhoneNo);
                                        } else {
                                            Toast.makeText(verifyOtp.this, "Enter OTP", Toast.LENGTH_LONG).show();
                                        }
                                    }
                                });
                    } else {
    ...
    public void onBackPressed() {
        if (backPressedTime + 2000 > System.currentTimeMillis()) {
            ...
            finishAffinity();
            super.onBackPressed();
            Toast.makeText(this, "Please wait for 60 seconds before try another OTP Login", Toast.LENGTH_SHORT).show();
            return;
        } else {
