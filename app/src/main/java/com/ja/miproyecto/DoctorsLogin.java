                        ...
                        databaseReference.child(encoded_email).addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                if (dataSnapshot.exists()) {
                                    ...
                                    // Check if usertype is not null and is "Admin" before invoking equals method
...
//                        startActivity(new Intent(DoctorsLogin.this, ForgotPassword.class));
                        Toast.makeText(DoctorsLogin.this, "A link has been sent to your Email to verify your account.", Toast.LENGTH_LONG).show();
                    }
                }
                else {
