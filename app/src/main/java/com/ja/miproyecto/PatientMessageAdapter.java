...
public class PatientMessageAdapter extends RecyclerView.Adapter<PatientMessageAdapter.ViewHolder> {
    ...
    public PatientMessageAdapter(Context mContext, List<Chat> mChat, String imageurl) {
    ...
    public int getItemViewType(int position) {
        PatientSessionManagement session = new PatientSessionManagement(mContext);
